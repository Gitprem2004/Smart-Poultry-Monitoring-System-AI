<<<<<<< HEAD
# Smart-Poultry-Monitoring-System-AI
YOLOv8 + DeepSORT + ResNet + Gemini AI based smart poultry monitoring system with real-time detection and health prediction
=======
...
*(Add screenshots or GIFs of the interface, detection results, etc.)*
